...
public class TbContentCategoryExample {
    ...
    /**
     *  获取当前的查询条件实例,tb_content_category
     */
    ...
    /**
     *  内部构建查询条件对象,tb_content_category
     */
